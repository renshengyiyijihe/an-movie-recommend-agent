...
export class MovieDiscoverTool implements ITool {
  ...
  name = "movie_discover";
  description =
    "根据类型、上映时间、评分、片长、原始语言、演职人员等条件筛选电影，并支持按热度、评分、票房、上映日期等方式排序。适用于电影推荐和条件筛选，例如“推荐高分科幻电影”“找2023年上映的动作片”“推荐诺兰参与且片长超过2小时的电影”。不适用于根据具体电影名称查询电影信息；已知或明确指定电影名称时，应使用 movie_search 工具。";
  ...
  schema = {
    ...
    properties: {
      language: {
        type: "string",
        description:
          "返回内容的语言。遵循 IETF language tag 格式，通常为 ISO 639-1 两位语言代码 + ISO 3166-1 alpha-2 两位地区代码，例如 'zh-CN'、'zh-TW'、'en-US'、'en-GB'。默认使用 'en-US'。",
      },
      page: {
        type: "integer",
